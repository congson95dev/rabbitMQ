...
def main():
    ...
    # Điều này có nghĩa là RabbitMQ sẽ xóa message khỏi queue ngay lập tức sau khi gửi message đến consumer, 
    ...
    # như là mất mát message hoặc xử lý trùng lặp message, nếu consumer không xử lý message thành công hoặc xảy ra lỗi. 
    # Do đó, việc sử dụng auto_ack=True nên được cân nhắc cẩn thận và chỉ được sử dụng trong các trường hợp đơn giản, 
